...
test("PHTD - Should be return Medium", () => {
   ...
   expect(handleStudent.getStudentType(7, 9, 9 , 9, handleStudent.ConductType.Medium))
      .toBe(handleStudent.StudentType.Medium)
   expect(handleStudent.getStudentType(9, 6, 9 , 9, handleStudent.ConductType.Rather))
      .toBe(handleStudent.StudentType.Medium)
   expect(handleStudent.getStudentType(6, 7, 6 , 9, handleStudent.ConductType.Good))
      .toBe(handleStudent.StudentType.Medium)
})
